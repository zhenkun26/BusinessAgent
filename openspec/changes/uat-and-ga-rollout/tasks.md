...
- [x] 3.2 评审灰度方案：确认比例、观察期（最短 4 周）与回滚路径可执行，结论落 `docs/40-process/DECISIONS.md` <!-- evidence: enterprise-agent/eval/validate_grey_release_plan.py; docs/40-process/灰度方案评审记录-2026-08-15.md; docs/40-process/DECISIONS.md §18; 结构评审条件通过，业务观察阈值仍需产品负责人确认 -->
