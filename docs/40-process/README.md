...
- `UAT计划评审记录-2026-08-15.md`：UAT 计划与 G0 fixture 的结构评审结论（资源未齐，不放行正式 UAT）
- `UAT执行准备核对报告-2026-08-15.md`：真实用户、环境、排期和签署资源核对结果（当前 BLOCKED）
- `下一步执行阻塞清单-2026-08-15.md`：三个 active change 的依赖、证据和严格执行顺序
- `发布门槛核对报告-2026-08-15.md`：六项上线门槛的程序化核对结果（当前 BLOCKED）
- `灰度方案评审记录-2026-08-15.md`：灰度方案条件评审结果（最短观察期 4 周，业务阈值待确认）
